...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-vp-debug.mk bin/nm

bin/nm: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.c} -o bin/nm ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/src/hasharray.o: nbproject/Makefile-${CND_CONF}.mk src/hasharray.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DPROBLEM_VP -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/hasharray.o src/hasharray.c

${OBJECTDIR}/src/btree.o: nbproject/Makefile-${CND_CONF}.mk src/btree.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DPROBLEM_VP -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/btree.o src/btree.c

${OBJECTDIR}/src/heap.o: nbproject/Makefile-${CND_CONF}.mk src/heap.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DPROBLEM_VP -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/heap.o src/heap.c

${OBJECTDIR}/src/set.o: nbproject/Makefile-${CND_CONF}.mk src/set.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DPROBLEM_VP -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/set.o src/set.c

${OBJECTDIR}/src/main.o: nbproject/Makefile-${CND_CONF}.mk src/main.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DPROBLEM_VP -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/main.o src/main.c

${OBJECTDIR}/src/problem-vp.o: nbproject/Makefile-${CND_CONF}.mk src/problem-vp.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DPROBLEM_VP -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/problem-vp.o src/problem-vp.c

${OBJECTDIR}/src/graf.o: nbproject/Makefile-${CND_CONF}.mk src/graf.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DPROBLEM_VP -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graf.o src/graf.c
